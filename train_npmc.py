...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/yolov7-voc.yaml', help='model.yaml path')
    ...
    parser.add_argument('--graphmodule-model', type=str, help='compressed model path (graphmodule)')
